...
<div class="row mb-4">
    ...
    <div class="col-md-3">
        <div class="card bg-primary text-white shadow">
            <div class="card-body">
                <h5>Total Abonnements</h5>
                <h2>{{ $totalSubscriptions ?? 0 }}</h2>
    ...
    <div class="col-md-3">
        <div class="card bg-success text-white shadow">
            <div class="card-body">
                <h5>Revenu Total</h5>
                <h2>{{ number_format($totalRevenue ?? 0, 2) }} DH</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-info">
                                {{ $sub->plan->name ?? $sub->plan_type ?? 'Basic' }}
                            </span>
                        </td>
                        ...
                        <td class="fw-bold">
                            {{ number_format($sub->total_amount ?? $sub->price ?? 0, 2) }} DH
                        </td>
